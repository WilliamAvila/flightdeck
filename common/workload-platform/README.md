...
| <a name="input_cluster_autoscaler_enabled"></a> [cluster\_autoscaler\_enabled](#input\_cluster\_autoscaler\_enabled) | Set to false to disable the Helm chart | `bool` | `true` | no |
...
| <a name="input_fluent_bit_enabled"></a> [fluent\_bit\_enabled](#input\_fluent\_bit\_enabled) | Set to false to disable the Helm chart | `bool` | `true` | no |
...
| <a name="input_metrics_server_enabled"></a> [metrics\_server\_enabled](#input\_metrics\_server\_enabled) | Set to false to disable the Helm chart | `bool` | `true` | no |
